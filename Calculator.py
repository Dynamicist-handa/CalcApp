...
button_add = Button(root, text="+", padx=30, pady=30, command=lambda: num_input("+")).grid(row=4, column=1)
button_clear = Button(root, text="clear", padx=30, pady=30, command=lambda: clear_val()).grid(row=5, column=0)
button_equal = Button(root, text="=", padx=30, pady=30, command=lambda: equals()).grid(row=5, column=1)
